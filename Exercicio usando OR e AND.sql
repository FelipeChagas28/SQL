...
/* Tragam os funcionarios que trabalhem no departamento de Filmes ou no
...
WHERE sexo = 'Feminino' and (departamento = 'Filmes' or departamento LIKE 'Lar');
...
SELECT nome, departamento from funcionarios
WHERE nome = 'Howard' and departamento ='Joalheria';

/* Cuidado com a "," dps do count(*) */
